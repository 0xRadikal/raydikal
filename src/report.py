...
Command-line report generator. Prints the full verified analysis:
  ...
  2. The Sepid-o-Zard formulation
...
def present_recipe() -> None:
    section("2. SEPID-O-ZARD - THE PROPOSED WHOLE-EGG DRINK")
...
def main() -> int:
    print()
    print(RULE)
    print("  SEPID-O-ZARD : a whole-egg espresso drink")
    ...
    print()
    print("  * Sepid-o-Zard uses the whole egg: yolk as a pasteurized")
